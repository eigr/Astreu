  ...
  def descriptor do
    ...
    Elixir.Google.Protobuf.ServiceDescriptorProto.decode(
      <<10, 9, 80, 117, 98, 108, 105, 115, 104, 101, 114, 18, 70, 10, 7, 80, 117, 98, 108, 105,
        ...
        108, 46, 77, 101, 115, 115, 97, 103, 101, 26, 24, 46, 97, 115, 116, 114, 101, 117, 46,
        112, 114, 111, 116, 111, 99, 111, 108, 46, 77, 101, 115, 115, 97, 103, 101, 34, 3, 136, 2,
        0, 40, 1, 48, 1>>
    )
  end

  rpc(:Publish, stream(Astreu.Protocol.Message), stream(Astreu.Protocol.Message))
end
